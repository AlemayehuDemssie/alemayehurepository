;(function () {
	...
	var sliderMain = function() {/*this is notimportant because the slider is replaced by custom js*/
	...
	var sliderTestimony = function() {
		...
		$('#fh5co-testimony .flexslider').flexslider({
			animation: "slide",
			slideshowSpeed: 10000,/*10second of delay for the slider text*/
			directionNav: false,
			controlNav: true,
			smoothHeight: true,
			reverse: true
...
/*the following lines of code made the header no animate so it is removed intentionally*/
	...
	var clickMenu = function() {
		...
		/*the following lines of code are bug for my code which makes the navigation bar only restricted for different section of the same page ruther than navigating to some other independent page */
		
		/*if ( $(this).attr('href') != "#") {
			$('#fh5co-main-00nav a:not([class="external"]), #fh5co-offcanvas a:not([class="external"])').click(function(event){
